      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm font-medium text-[#685B55] mt-1">
            Manage product catalog, primary images, and hover images.
          </p>
        </div>
        <button
          type="button"
          onClick={() => setShowForm(!showForm)}
          className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-[#3B6E4C] hover:bg-[#285642] text-white font-bold text-sm shadow-md transition-all active:scale-95 cursor-pointer"
        >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Nutrition highlights: 20% Protein, 25% Fiber, Zero Added Sugar..."
              ...
              <div className="p-4 rounded-2xl border-2 border-dashed border-[#E88D36]/30 bg-[#FFF9F0]">
                ...
                {hoverPreview ? (
                  ...
                  <label className="flex flex-col items-center justify-center p-6 bg-white border border-[#E5DCDB] rounded-xl cursor-pointer hover:border-[#E88D36] transition-all">
                    ...
                    <span className="text-[10px] text-[#685B55]">Shown on card hover</span>
                    <input
                      type="file"
                      accept="image/*"
                      className="hidden"
                  ...
                  <td className="py-4 px-6 text-right">
                    <div className="inline-flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-[#FAF6EE] hover:bg-[#FAF0DE] border border-[#E5DCDB] text-xs font-black uppercase tracking-wider text-[#2C221E] flex items-center gap-1.5 transition-colors cursor-pointer"
                      >
          ...
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl space-y-6 animate-scaleIn">
            <div className="flex items-center justify-between border-b border-[#E5DCDB] pb-4">
              ...
              <button
                ...
                className="p-2 text-[#685B55] hover:text-[#2C221E] rounded-full hover:bg-[#FAF6EE] cursor-pointer"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="p-5 rounded-2xl border-2 border-[#3B6E4C]/20 bg-[#FAF6EE] flex flex-col items-center text-center">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-[#3B6E4C] hover:bg-[#285642] text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-sm cursor-pointer"
                >
              ...
              <div className="p-5 rounded-2xl border-2 border-[#E88D36]/20 bg-[#FFF9F0] flex flex-col items-center text-center">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-[#E88D36] hover:bg-[#D47E2A] text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-sm cursor-pointer"
                >
            ...
            <div className="flex justify-end pt-2">
              <button
                type="button"
                onClick={() => setImageModalProduct(null)}
                className="px-6 py-2.5 rounded-xl bg-[#2C221E] text-white text-xs font-bold uppercase tracking-wider hover:bg-black transition-colors cursor-pointer"
              >
                Done
              </button>
            </div>
